...
<div class="container">
<h5 class ="text-success">Register Here </h5>

<form action = RegistrationSevlet onSubmit = "return checkPassword(this)">
...
<div class="text-center"> 
 ...
 <div class="text-center"> 
             ...
             <a href="signin.jsp" class="btn btn-lg btn-info" role="button">SignIn</a>
        </div> 
</form>
